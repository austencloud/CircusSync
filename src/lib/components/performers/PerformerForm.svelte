...
<form on:submit|preventDefault={handleSubmit} class="space-y-6">
	...
	<div>
				...
				{#each formData.skills as skill, index}
					<div class="bg-white border rounded-lg p-4 relative">
						...
						<div class="flex items-center mb-2">
							<span
								class={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getColorForSkill(
									skill.category
								)}`}
							>
							...
							<span
								class={`ml-2 inline-block px-2 py-0.5 rounded-full text-xs font-medium ${getColorForSkillLevel(
									skill.level
								)}`}
							>
							...
							<div class="mb-2">
								...
								<div class="flex flex-wrap gap-1 mt-1">
									{#each skill.props as prop}
										<span
											class="inline-block px-2 py-0.5 bg-gray-100 text-gray-800 rounded-full text-xs"
										>
											{prop}
										</span>
									{/each}
		...
		<div class="bg-gray-50 rounded-lg p-4 border">
			...
			<div class="mt-4">
				<Button type="button" on:click={addSkill} size="sm">
		...
		<div class="bg-gray-50 rounded-lg p-4 border">
			...
			<div class="max-w-xl">
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					...
					<!-- Pay Rate Unit -->
					<div>
						<label for="payUnit" class="block text-xs font-medium text-gray-500 mb-1"> Unit </label>
						<select
							id="payUnit"
